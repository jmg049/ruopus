...
//! prefer :class:`ruopus.OpusEncoder` / :class:`ruopus.OpusDecoder`,
...
#[pyclass(module = "ruopus.lowlevel", name = "CeltEncoder")]
...
///     Defaults to 48000.
#[pyclass(module = "ruopus.lowlevel", name = "CeltDecoder")]
