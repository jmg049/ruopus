//! Python bindings for `ruopus`, built with [PyO3].
//!
...
//! `ruopus` extension module. Every item is declared so PyO3's
...
/// Returns the `ruopus` crate version (the Rust ``CARGO_PKG_VERSION``).
///
/// Examples
/// --------
/// >>> import ruopus
